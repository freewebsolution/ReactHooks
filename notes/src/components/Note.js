    ...
    return (
        <li className='collection-item' style={{ borderBottom: '1px solid #dadada' }}>
            <span className='title'>
                <span style={{ textTransform: 'capitalize' }}>{nota.tema}</span> il giorno
                 <span style={{ color: 'green', fontSize: '20px', backgroundColor: '#dadada' }}
                >
                    {day}
                </span>
                  alle ore
                <span
                    style={{ color: 'orange', fontSize: '18px', backgroundColor: '#dadada' }}
                >
                    {nota.ora}
                </span>
            </span>
