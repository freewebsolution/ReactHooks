...
const Note = ({ nota, toggleImportance, deleteNote,editNote }) => {
    ...
    return (
        <li className='collection-item' style={{ borderBottom: '1px solid #dadada' }}>
            ...
            <span className="secondary-content">
                ...
                <button onClick={editNote} style={{ marginLeft: '5px' }} className='btn-floating btn-small waves-effect waves-light blue'> <i className="material-icons">mode_edit</i></button>
